...
class Ui_MainGuiWindow(object):
    def setupUi(self, MainGuiWindow):
        ...
        self.devicesTabWidget = QtWidgets.QTabWidget(self.widget)
        ...
        self.anotherExitButton = QtWidgets.QPushButton(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_10.addItem(spacerItem8, 7, 0, 1, 1)
        ...
        self.gridLayout_29.addItem(spacerItem16, 1, 1, 1, 1)
