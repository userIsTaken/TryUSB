...
class Ui_MainGuiWindow(object):
    def setupUi(self, MainGuiWindow):
        ...
        self.gridLayout_10.addWidget(self.dataViewWidget, 0, 3, 10, 1)
        ...
        self.gridLayout_10.addWidget(self.plainConfigOscilograph, 9, 0, 1, 2)
